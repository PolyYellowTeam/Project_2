...
<div id="content">
	<div id="content-header">
		...
		<h1 style="margin-top: 2px; margin-bottom: 0;">Chỉnh sửa nhân viên</h1>
	</div>
			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5><a href="QLEdata">Quay lại</a></h5>
					</div>
					<div class="widget-content nopadding">
						<form:form action="updateEMP" class="form-horizontal"
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input path="accounts.username" readonly="true" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:select path="roles">
										<form:option value="1">Nhân viên cấp 1</form:option>
										<form:option value="0">Nhân viên cấp 2</form:option>
									</form:select>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<form:select path="status">
										...
										<form:option value="false">De-Active</form:option>
									</form:select>
								</div>
							</div>
							<div class="form-actions">
