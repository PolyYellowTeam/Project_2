...
<div id="content">
	<div id="content-header">
		...
		<h1 style="margin-top: 2px; margin-bottom: 0;">Cập nhập Seo keyword</h1>
	</div>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form:form action="updateSEO" class="form-horizontal"
							modelAttribute="SEO" method="post">
							<div class="form-actions">
								<label class="control-label" style="color: red;">${messageerrors }</label>
							</div>
							<div class="control-group">
								<div class="controls">
									<form:hidden class="span11"
										placeholder="Nhập nội dung banner..." path="keywordId" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<form:textarea class="span11"
										placeholder="Nhập nội dung banner..." path="keyword" rows="4"
										cols="26" /><br>
