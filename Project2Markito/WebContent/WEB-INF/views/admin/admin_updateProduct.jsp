			...
			<div class="span12">				
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>Cập nhật sản phẩm<span style="margin-left: 30px;${status?'color:#5bb75b;':'color:#da4f49;'} font-size: 16px">${message}</span></h5>						
					</div>
					<div class="widget-content nopadding">
						<form:form action="mngproducts?updateProduct" modelAttribute="product" enctype="multipart/form-data" method="post" class="form-horizontal" >
						    <div id="idProduct" class="control-group">
